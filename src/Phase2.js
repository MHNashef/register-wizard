            ...
            <Container>
                <Form onSubmit={onSubmit}>
                    <Form.Group controlId="formBasicCity">
                        ...
                        <Form.Control type="text" name="City" placeholder="Enter city" onBlur={checkEmpty}/>
                        {
                            emptyCityError &&
                    ...
                    <Form.Group controlId="formBasicStreet">
                        ...
                        <Form.Control type="text" name="Street" placeholder="Street" onBlur={checkEmpty}/>
                        {
                            emptyStreetError &&
                    ...
                    <Form.Group controlId="formBasicNumber">
                        ...
                        <Form.Control type="number" min="1" max="999" name="Number" placeholder="Number" onBlur={updateNumValue}/>
                        {/* {
                            invalidNumError &&
